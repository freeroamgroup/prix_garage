...
Config.JobGarajesEnabled = false

Config.JobVehicleShopEnabled = false
...
Config.Garages = {
    ...
    ['shores'] = {
        access = vec4(1253.1425, 2711.7009, 38.0058, 93.7778),
        store = vec4(1243.6993, 2718.9668, 38.0058, 81.6531),
        spawn = vec4(1248.5182, 2710.6396, 38.0058, 180.2143),
        type = 'car',
        blip = true
    },
    ['aguja'] = {
